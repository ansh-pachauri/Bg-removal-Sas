        ...
        <div className='pb-10 md:py-20 mx-2'>
            ...
            <div className='relative w-full max-w-3xl overflow-hidden m-auto rounded-xl'>
                ...
                style={{clipPath:`inset( 0 ${100.2 - sliderPosition}% 0 0)` }}
                 ...
                 {/**Slider */}
                 <input className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full  z-20 slider' type="range" min={0} max={100} value={sliderPosition} onChange={handleSlider} />
            </div>
        </div>
    )
}
